...
static const int topbar             = 1;        /* 0 means bottom bar.1 means top bar */
...
static const char *downvol[] = { "/home/manjaro/dwm-6.2/scripts/vol-down.sh",  NULL };
static const char *mutevol[] = { "/home/manjaro/dwm-6.2/scripts/vol-toggle.sh",  NULL };
*/
static const char *upvol[]   = { "/usr/bin/amixer", "-qM", "set", "Master", "5%+", "umute",  NULL };
static const char *downvol[] = { "/usr/bin/amixer", "-qM", "set", "Master", "5%-", "umute",  NULL };
